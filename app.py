...
from config import DEFAULT_SUBREDDIT, MONITOR_INTERVAL, logging
...
def main():
    ...
    auto_refresh = st.checkbox("Monitor Every 5 Minutes", value=False)
        ...
        for _, row in df.iterrows():
            st.markdown(f'''
                <div class="output">
                    ...
                    <strong>Reach:</strong> {row["Reach"]}<br>
